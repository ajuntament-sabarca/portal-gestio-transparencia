...
<ul class="nav navbar-right top-nav">
	...
	?>
		<li class="dropdown">
			...
			?>
			<ul class="dropdown-menu message-dropdown">
				<?php admin_llista_avisos_no_vist(1, 2); ?>
			</ul>
		</li>
	<?php }	?>
	
	<li class="dropdown">
		<a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Pmsports Sant Andreu de la Barca <b class="caret"></b></a>
		<ul class="dropdown-menu">
			...
			if($_SESSION["permisos"]==99){
				echo "<li>";
					echo "<a href=\"../usuaris.php?ens=2\"><i class=\"fa fa-fw fa-gear\"></i> Administraci&oacute;</a>";
				echo "</li>";
			}
			?>
			<li>
				<a href="../perfil.php?ens=2"><i class="fa fa-fw fa-gear"></i> Opcions</a>
			</li>
			<li>
